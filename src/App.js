    ...
    <div className="wrapper clear">
      ...
      <div className="overlay" style={{display: "none"}}>
        <div className="drawer">
          ...
          <div className="items mt-30">
            ...
            <button className="btn-main">Оформить заказ</button>
      ...
      <header className="d-flex justify-between align-center p-40">
        <div className="d-flex align-center">
          <img src="img/image 4.png" width={40} height={40} className="mr-15" />
        ...
        <ul className="d-flex">
          <li className="mr-30">
          <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-15">
